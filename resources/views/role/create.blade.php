        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header elegant-color-dark">
                    <h2 class="text-center text-light font-weight-bold">Creación de Roles</h2>
                </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <h3>Datos Requeridos</h3>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Descripción" rows="3">{{old('descripcion')}}</textarea>
                            </div>
